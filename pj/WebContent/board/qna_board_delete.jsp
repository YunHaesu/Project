					...
					<div class="form-col">
						<div class="form-group">
							 <input placeholder="글 비밀번호"
								name="board_pass" class="form-control" type="password"
								id="board_pass" required="required" /> <input
								name="board_delete" class="form-control" id="board_delete"
								type="submit" value="삭제" />&nbsp;&nbsp; <input
								name="board_return" class="form-control" id="board_return"
