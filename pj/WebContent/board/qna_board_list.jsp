...
<body>
 ...
 %> <a
			...
			<section id="pageList">
				...
				%>
				<a href="boardList.do?page=<%=nowPage - 1%>" class="btn btn-primary">이전</a>&nbsp;
				<%
					}
				%>
				<%
				...
				<a href="boardList.do?page=<%=a%>" class="btn btn-primary"><%=a%>
				</a>&nbsp;
				<%
					}
				%>
				...
				%>
				<a href="boardList.do?page=<%=nowPage + 1%>" class="btn btn-primary">다음</a>
				<%
					}
				%>
			</section>
