...
%>
<%
	int recommand_num = (Integer) request.getAttribute("recommand_num");
		...
		<div class="container pt-4 ">
			<div class="text-center m-3 ">
				<form name="deleteForm"
					action="recommandDeletePro.do?recommand_num=<%=recommand_num%>" method="post">
					<input type="hidden" name="page" value="<%= nowPage%>" />
					<div class="form-col">
						<div class="form-group">
							 <input placeholder="글 비밀번호"
								name="recommand_pass" class="form-control" type="password"
								id="recommand_pass" required="required" /> <input
								name="recommand_delete" class="form-control" id="recommand_delete"
								type="submit" value="삭제" />&nbsp;&nbsp; <input
								name="recommand_return" class="form-control" id="recommand_return"
